...
import { Tabs, TabPanel, Input, Button, message } from "tea-component";
...
export const LoginContent = (): JSX.Element => {
    ...
    return (
        <div className="login--context">
            <h2 className="login--context__title">登录财乎</h2>
                ...
                <TabPanel id="verifyCodeLogin">
                    {
                        smsLoginToken && smsLoginUserId ? (
                            <div className="captche-row">
                                ...
                                <Button className="cap-btn" type="weak" onClick={getCode}>获取验证码</Button>
                            </div>
                        ) : (
                            <Fragment>
                                <div className="captche-row">
